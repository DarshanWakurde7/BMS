           ...
           decoration: BoxDecoration(
            ...
            child: Padding(
              ...
              child: Column(
               ...
               Text("${widget.type}",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w500),),
                  Row(
               ...
               Text("Created: ${widget.created}",style: TextStyle(fontSize: 13,fontWeight: FontWeight.w400),),
      ...
      Row(
        children: [
          ...
          Expanded(
               ...
               Text("Details: ${widget.require}",style: TextStyle(fontSize: 12,fontWeight: FontWeight.w400),),
                  ...
                  //   )),
                    ...
                    children: [
                      ...
                      SizedBox(width: 3,),
                      Text("Next Appt:${widget.appointment}",style: TextStyle(fontSize: 13,fontWeight: FontWeight.w500),)
          ...
          GestureDetector(child: CircleAvatar(
            radius: 13,
            backgroundImage: AssetImage("asset/image/whatsapp_733585.png")),
          onTap: ()async{
         ...
         String response= await ApiCalls.postEnquireCOmments("0", widget.id.toString(), "", "", "", "the customer is texted via whatsapp", (sharedPreferences.getInt("user_id")).toString(), (sharedPreferences.getInt("account_id")).toString());
          ...
          GestureDetector(
            onTap: ()async{
                  ...
                  SharedPreferences sharedPreferences =await SharedPreferences.getInstance();
                      String response= await ApiCalls.postEnquireCOmments("0", widget.id.toString(), "", "", "", "Call has placed to customer", (sharedPreferences.getInt("user_id")).toString(), (sharedPreferences.getInt("account_id")).toString());
            },
            child: CircleAvatar(
              backgroundColor: Colors.transparent,
              radius: 13,
              child: Icon(Icons.phone,color: Colors.blueAccent,size: 26,),
             )),
          GestureDetector(
            onTap: ()async{
                    ...
                    mode: LaunchMode.externalApplication
                     ...
                     SharedPreferences sharedPreferences =await SharedPreferences.getInstance();
                      String response= await ApiCalls.postEnquireCOmments("0", widget.id.toString(), "", "", "", "Mail sent to Customer", (sharedPreferences.getInt("user_id")).toString(), (sharedPreferences.getInt("account_id")).toString());
            },
            child: Icon(Icons.email_outlined,color: Colors.redAccent,size: 26,)),
          GestureDetector(
            onTap: (){
              ...
              showBottomSheet(
                ...
                child: Card(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text("Sorry no Comments yet",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                    ),
                  ),
                ),
              );
                            ...
                            return  ListView.builder(
                                ...
                                return EnquireComment(name: commentController.commentsdata[index].createdFname??"", date: commentController.commentsdata[index].updatedAt??"", comment: commentController.commentsdata[0].message??"", nextfollupdate: commentController.commentsdata[0].followUpDate??"", status: "followup",profile: commentController.commentsdata[0].profilePath??"profilepicture/G1SMGwzAvl1eYTZhsh7YfqVFMD9m0ElikUIIQGGy.webp",);
                                                        });
...
SharedPreferences sharedPreferences=await SharedPreferences.getInstance();
  commentController.getEnquireComments(sharedPreferences.getInt("account_id")??0, widget.id);
