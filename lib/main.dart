                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: GestureDetector(
                          ...
                          child: const Icon(Icons.visibility_off_outlined,size: 24)),
                 ...
                 SizedBox(height: MediaQuery.of(context).size.height*0.075,),
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      gradient: LinearGradient(colors: [Color.fromARGB(255, 2, 177, 246),Color.fromARGB(255, 0, 143, 191),Color.fromARGB(255, 0, 109, 242),Color.fromARGB(255, 0, 34, 168)],
                    ...
                    child: ElevatedButton(onPressed: (){
                                 ...
                                 RegExp regex = RegExp(r'^[a-z0-9]+(?:[_-][a-z0-9]+)*$', caseSensitive: false);    
                          if((username.text.isNotEmpty) && (password.text.isNotEmpty)){
                          

                    
                                    checkLogin(username.text.toString(),password.text.toString(),context);
                                    
                          }else{
                          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content:Text("Sorry please enter all valid fields!!"),backgroundColor: Colors.redAccent,));
...
Future<dynamic> checkLogin(String username,String password,BuildContext context) async{
...
if(data['success']){
  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Login SuccessFull"),backgroundColor: Colors.blueAccent,));
...
sharedPref.setString("user_email", loginResponse[0].profilePath.toString());
sharedPref.setString("username", loginResponse[0].profilePath.toString());
sharedPref.setString("user_full_name", loginResponse[0].profilePath.toString());
sharedPref.setString("account_display_name", loginResponse[0].profilePath.toString());
sharedPref.setString("profile_path", loginResponse[0].profilePath.toString());
sharedPref.setString("product_display_name", loginResponse[0].profilePath.toString());
